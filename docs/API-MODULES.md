...
- `src/modules/templates/prebuilt-templates.ts` defines starter HR Generalist, Software Engineer, and Team Leader tests with modules, questions, weights, and rubrics.
