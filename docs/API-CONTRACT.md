...
| PATCH | `/sessions/:id/integrity-policy` | Workspace | Enable or pause pointer-exit detection for one session. The body is `{ "pointerDetectionEnabled": boolean }`; visibility-change detection remains active. |
